...
<?php if($cod == '200'):?>
            <div class="card c-card ">
                ...
                <div class="card-body">
                    ...
                    <p class="card-text">Current Temperature :<span style="color:"> <?php echo $temp ?>°C </span></p>
                    <p class="card-text">Min Temperature : <?php echo $temp_min ?>°C</p>
                    <p class="card-text">Max Temperature : <?php echo $temp_max ?>°C</p>
